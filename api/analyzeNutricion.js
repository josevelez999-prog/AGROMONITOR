...
export default async function handler(req, res) {
  ...
  try {
    ...
    const fullPrompt = `Eres un experto en nutrición hidropónica y fórmulas de fertilización. 

${prompt}

Responde en español, de forma práctica y específica con números cuando aplique.`;
    ...
    if (!texto) return res.status(200).json({ error: "Claude no devolvió respuesta." });
